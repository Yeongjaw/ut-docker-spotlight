...
module Migration
  ...
  class IIIF
    ...
    def copy_exhibit_thumbnail_from_featured_image(image)
      ...
      filepath = "/home/rvm/storage/#{image.image.store_dir}/#{filename}"
    ...
    def copy_contact_image_to_avatar(contact)
      ...
      filepath = "/home/rvm/storage/uploads/spotlight/contact/avatar/#{contact.id}/#{filename}"
      return unless filename.present? && File.exist?(filepath)
    ...
    def copy_upload_to_featured_image(upload)
      ...
      filepath = "/home/rvm/storage/uploads/spotlight/resources/upload/url/#{upload.id}/#{filename}"
      return unless filename.present? && File.exist?(filepath)
