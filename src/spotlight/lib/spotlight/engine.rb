...
module Spotlight
  ...
  class Engine < ::Rails::Engine
    ...
    config.iiif_contributorConsolidated_fields = nil
    config.iiif_keydateSort_fields = nil
    config.iiif_abstract_fields = nil
    config.iiif_noteTypeGeneral_fields = nil
    config.iiif_geographicCoverageConsolidated_fields = nil
    config.iiif_displayLanguage_fields = nil
    config.iiif_locationPhysicalLocation_fields = nil
    config.iiif_subjectGeographic_fields = nil
    config.iiif_accessCondition_fields = nil
    config.iiif_relatedItemIdentifier_fields = nil
    config.iiif_relatedItemTitleInfo_fields = nil
    config.iiif_subtitlePrimary_fields = nil
    config.iiif_subjectTemporal_fields = nil
    config.iiif_subjectTopic_fields = nil
    config.iiif_subtitleTranslated_fields = nil
    config.iiif_titleTranslated_fields = nil
    config.iiif_typeConsolidated_fields = nil
    config.iiif_thumbnail_fields = nil
    config.iiif_physicalDescription_fields = nil
