...
describe Spotlight::IndexingCompleteMailer do
  subject { described_class.documents_indexed [1, 2, 3], exhibit, user, row_cntr, error_items }
  ...
  context 'single item' do
    subject { described_class.documents_indexed [1], exhibit, user, row_cntr, error_items }
